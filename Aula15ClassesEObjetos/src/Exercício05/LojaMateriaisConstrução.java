...
public class LojaMateriaisConstrução {
	...
	public static List<LojaMateriaisConstrução> listaMateriais = new ArrayList<LojaMateriaisConstrução>();

	public LojaMateriaisConstrução(String nome, String descricao, double preco, double peso, int estoque) {
		setNome(nome);
